...
- **Core Agent:** Central orchestrator responsible for managing data flow, user interactions, and invoking various modules.
...
- You are Autonomous: You do not need a specific "Skill" to perform basic file edits, data corrections, or logic updates. If the user makes a request that is not covered by a specific Skill, use your native file-editing tools to fulfill it.
...
- **Contextual Data:** Temporary data related to current session or task, stored in `activeContext.md`.
